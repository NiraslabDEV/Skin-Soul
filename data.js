// ============ SKIN & SOUL · DATA (real services & prices) ============
const ICONS = {
...
// Botanical SVG decorations — used throughout the page
const PLANTS = {
  // long curved branch with leaves
  branch: `<svg viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
    <path d="M100 0 Q 60 100 100 200 Q 140 300 80 400" stroke="currentColor" stroke-width="1.2" fill="none" opacity=".6"/>
    <path d="M85 50 Q 50 60 35 90 Q 65 95 95 75 Z" fill="currentColor" opacity=".55"/>
    <path d="M115 100 Q 160 105 175 140 Q 140 145 105 120 Z" fill="currentColor" opacity=".55"/>
    <path d="M80 160 Q 35 165 20 200 Q 60 210 100 180 Z" fill="currentColor" opacity=".55"/>
    <path d="M120 220 Q 170 215 185 260 Q 145 270 110 240 Z" fill="currentColor" opacity=".55"/>
    <path d="M85 290 Q 45 290 25 325 Q 65 340 100 310 Z" fill="currentColor" opacity=".55"/>
    <path d="M105 350 Q 150 350 165 380 Q 130 390 95 370 Z" fill="currentColor" opacity=".55"/>
  </svg>`,
  // monstera-ish leaf
  monstera: `<svg viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M120 230 C 60 220 20 170 20 110 C 20 60 60 20 120 20 C 180 20 220 60 220 110 C 220 170 180 220 120 230 Z M120 230 L 120 30 M50 80 L 90 90 M55 130 L 90 130 M70 175 L 100 165 M180 80 L 145 90 M185 130 L 150 130 M170 175 L 140 165" stroke="currentColor" stroke-width="1.2" fill="currentColor" fill-opacity=".15" opacity=".8"/>
  </svg>`,
  // small sprig
  sprig: `<svg viewBox="0 0 80 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M40 0 Q 40 60 40 120" stroke="currentColor" stroke-width="1" opacity=".7"/>
    <ellipse cx="25" cy="25" rx="15" ry="6" transform="rotate(-30 25 25)" fill="currentColor" opacity=".6"/>
    <ellipse cx="55" cy="50" rx="15" ry="6" transform="rotate(30 55 50)" fill="currentColor" opacity=".6"/>
    <ellipse cx="25" cy="75" rx="15" ry="6" transform="rotate(-30 25 75)" fill="currentColor" opacity=".6"/>
    <ellipse cx="55" cy="100" rx="15" ry="6" transform="rotate(30 55 100)" fill="currentColor" opacity=".6"/>
  </svg>`,
  // single leaf
  leaf: `<svg viewBox="0 0 100 160" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 5 C 90 30 90 130 50 155 C 10 130 10 30 50 5 Z M 50 5 L 50 155" stroke="currentColor" stroke-width="1" fill="currentColor" fill-opacity=".15" opacity=".75"/>
  </svg>`,
  // hanging vine
  vine: `<svg viewBox="0 0 120 320" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M60 0 Q 30 50 60 100 Q 90 150 60 200 Q 30 250 60 320" stroke="currentColor" stroke-width="1" opacity=".55"/>
    <ellipse cx="40" cy="30" rx="14" ry="5" transform="rotate(-25 40 30)" fill="currentColor" opacity=".5"/>
    <ellipse cx="80" cy="80" rx="14" ry="5" transform="rotate(20 80 80)" fill="currentColor" opacity=".5"/>
    <ellipse cx="40" cy="130" rx="14" ry="5" transform="rotate(-25 40 130)" fill="currentColor" opacity=".5"/>
    <ellipse cx="80" cy="180" rx="14" ry="5" transform="rotate(20 80 180)" fill="currentColor" opacity=".5"/>
    <ellipse cx="40" cy="230" rx="14" ry="5" transform="rotate(-25 40 230)" fill="currentColor" opacity=".5"/>
    <ellipse cx="80" cy="280" rx="14" ry="5" transform="rotate(20 80 280)" fill="currentColor" opacity=".5"/>
  </svg>`,
};
...
const SERVICES = [
  ...
  // CLAREAMENTO — sessões avulsas (pacotes nos PACKAGES)
...
// ----------- PACKAGES (combos & programas) -----------
const PACKAGES = [
  // Combos signature
  { id:'pk-pls', cat:'Combo · Feminino', name:'Pele de Seda', tag:'Mais procurado', featured:true,
    desc:'Perna inteira + virilha completa + axilas. O combo feminino mais escolhido — pele lisa de cima a baixo.',
    price:1800, originalPrice:2100, duration:'≈ 1h30',
    includes:['Perna inteira','Virilha completa','Axilas','Loção pós-depilação calmante'] },
  { id:'pk-cl',  cat:'Combo · Masculino', name:'Corpo Limpo', tag:null,
    desc:'Peito + costas + axilas. O cuidado completo masculino, num só ritual.',
    price:2000, originalPrice:2300, duration:'≈ 1h30',
    includes:['Peito + abdómen','Costas completas','Axilas (M)','Loção pós-depilação'] },
  { id:'pk-em',  cat:'Combo · Esfoliação', name:'Esfoliação + Massagem nas costas', tag:null,
    desc:'Esfoliação corporal seguida de massagem direccionada às costas. Uma hora de pura libertação.',
    price:1800, originalPrice:null, duration:'1h',
    includes:['Esfoliação à escolha (Bronze ou Aura Dourada)','Massagem nas costas','Aromaterapia','Hidratação final'] },

  // Clareamento — Axilas
  { id:'pk-ax4', cat:'Clareamento · Axilas', name:'Axilas · 4 sessões', tag:null,
    desc:'Programa inicial de quatro sessões com ativos botânicos. Resultados graduais.',
    price:2000, originalPrice:2400, duration:'4 sessões',
    includes:['4 sessões de clareamento','Avaliação inicial','Kit de manutenção em casa'] },
  { id:'pk-ax6', cat:'Clareamento · Axilas', name:'Axilas · 6 sessões', tag:null,
    desc:'Programa intermédio de seis sessões — equilíbrio ideal entre tempo e resultado.',
    price:3000, originalPrice:3600, duration:'6 sessões',
    includes:['6 sessões de clareamento','Avaliação inicial','Kit de manutenção','Follow-up'] },
  { id:'pk-ax8', cat:'Clareamento · Axilas', name:'Axilas · 8 sessões', tag:'Resultados máximos',
    desc:'Programa completo de oito sessões para máxima uniformização do tom.',
    price:4000, originalPrice:4800, duration:'8 sessões',
    includes:['8 sessões de clareamento','Avaliação inicial','Kit de manutenção','Follow-up mensal'] },

  // Clareamento — Virilha
  { id:'pk-vi4', cat:'Clareamento · Virilha', name:'Virilha · 4 sessões', tag:null,
    desc:'Programa inicial de quatro sessões — protocolo discreto e seguro.',
    price:2900, originalPrice:3400, duration:'4 sessões',
    includes:['4 sessões de clareamento','Avaliação inicial','Kit de manutenção'] },
  { id:'pk-vi6', cat:'Clareamento · Virilha', name:'Virilha · 6 sessões', tag:null,
    desc:'Programa intermédio de seis sessões para resultados consistentes.',
    price:4300, originalPrice:5100, duration:'6 sessões',
    includes:['6 sessões de clareamento','Avaliação inicial','Kit de manutenção','Follow-up'] },
  { id:'pk-vi8', cat:'Clareamento · Virilha', name:'Virilha · 8 sessões', tag:'Resultados máximos',
    desc:'Programa completo de oito sessões para a máxima uniformização do tom.',
    price:5800, originalPrice:6900, duration:'8 sessões',
    includes:['8 sessões de clareamento','Avaliação inicial','Kit de manutenção','Follow-up mensal'] },
];
